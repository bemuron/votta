      ...
      <div class="aside-body">
        ...
        @else
          ...
          <ul class="nav nav-aside">
            ...
            <li class="nav-item" id="dash-elections"><a href="{{ route('manage_elections') }}" class="nav-link"><i data-feather="calendar"></i> <span>Elections</span></a></li>
            <li class="nav-item" id="dash-posts"><a href="{{ route('manage_positions') }}" class="nav-link"><i data-feather="message-square"></i> <span>Posts</span></a></li>
            <li class="nav-item" id="dash-candidates"><a href="{{ route('manage_candidates') }}" class="nav-link"><i data-feather="users"></i> <span>Candidates</span></a></li>
            <li class="nav-label mg-t-25">User Management</li>
            <li class="nav-item" id="dash-users"><a href="{{ route('statistics') }}" class="nav-link"><i data-feather="calendar"></i> <span>Users</span></a></li>
            <li class="nav-item" id="dash-divisions"><a href="app-chat.html" class="nav-link"><i data-feather="message-square"></i> <span>Divisions</span></a></li>
            <li class="nav-item" id="dash-sub-divisions"><a href="app-chat.html" class="nav-link"><i data-feather="message-square"></i> <span>Sub Divisions</span></a></li>
